...
&& apk add --no-cache alpine-baselayout ca-certificates-bundle python3 wget libxml2 mailcap tini brotli git bash su-exec \
&& pip3 install --break-system-packages --no-cache -r requirements.txt \
&& pip3 install --break-system-packages --no-cache "uwsgi~=2.0" \
